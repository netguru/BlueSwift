...
class ViewController: UIViewController {
    ...
    func advertise() {
        ...
        let peripheral = Peripheral(configuration: configuration, advertisementData: [.localName("Test"), .servicesUUIDs("58D48B4E-4F40-4E6A-8C4E-23B1B54452A9"), .servicesUUIDs("58D48B4E-4F41-4E6A-8C4E-23B1B54452A9")])
